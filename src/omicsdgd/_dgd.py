...
class DGD(nn.Module):
    ...
    def gene2peak(self, gene_name, testset, gene_ref=None, plot=False, quantile=None):
        ...
        if quantile is not None:
            predicted_changes = [predicted_changes[i][samples_outside_quantile,:] for i in range(len(self.train_set.modalities))]
            indices_of_interest_gene = indices_of_interest_gene[samples_outside_quantile]

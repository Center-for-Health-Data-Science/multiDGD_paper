...
ax_list.append(plt.subplot(gs[9:, 4:7]))
...
ax_list[-1].legend(
    bbox_to_anchor=(1.0 + legend_x_dist, 1.3 + legend_y_dist),
    loc="upper left",
    frameon=False,
...
ax_list.append(plt.subplot(gs[9:12, 2:4]))
...
####################################
####################################
ax_list.append(plt.subplot(gs[9:12, 0:2]))
...
plt.savefig(
    "../results/revision/plots/main/fig2_revision_v1.png",
    dpi=300,
    bbox_inches="tight",
)

...
#model_name = 'l20_e3_d3h200_rs'+str(random_seed)+'_featselect'+str(threshold).split('.')[1]+'_forTime'
model_name = 'l20_e2_d2_rs'+str(random_seed)+'_featselect'+str(threshold).split('.')[1]+'_forTime'

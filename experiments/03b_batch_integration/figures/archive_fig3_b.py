...
# plot them
ax_list.append(fig.add_subplot(gs[0:2, 0:2]))
ax_list[-1].text(
...
ax_list.append(fig.add_subplot(gs[0:2, 2:4]))
sns.scatterplot(
    data=rep_sup,
    x="D1",
    y="D2",
...
ax_list.append(fig.add_subplot(gs[2:4, 0:2]))
sns.scatterplot(
    data=rep_default,
    x="D1",
    y="D2",
...
ax_list.append(fig.add_subplot(gs[2:4, 2:4]))
sns.scatterplot(
    data=rep_sup,
    x="D1",
    y="D2",
...
ax_list.append(fig.add_subplot(gs[5:7, :4]))
ax_list[-1].text(
...
# rep_sup = rep_sup.sample(frac=1)
# plot them
ax_list.append(fig.add_subplot(gs[0:2, 6:8]))
ax_list[-1].text(
    grid_letter_positions[0] - 0.055,
    1.15,
    "B",
...
ax_list.append(fig.add_subplot(gs[0:2, 8:10]))
sns.scatterplot(
    data=rep_sup,
    x="D1",
    y="D2",
...
rep_default = rep_default.sort_values(by="seen", ascending=True)
rep_sup = rep_sup.sort_values(by="seen", ascending=True)
ax_list.append(fig.add_subplot(gs[2:4, 6:8]))
sns.scatterplot(
    data=rep_default,
    x="D1",
    y="D2",
...
ax_list.append(fig.add_subplot(gs[2:4, 8:10]))
sns.scatterplot(
    data=rep_sup,
    x="D1",
    y="D2",
...
ax_list.append(fig.add_subplot(gs[5:7, 6:]))
ax_list[-1].text(
...
plt.savefig(
    plot_dir + "plots/main/fig3_second_part.png", dpi=720, bbox_inches="tight"
)